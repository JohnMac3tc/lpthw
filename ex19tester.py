...
def cash_in_wallet(dollars_count, cents_count):
    print "You have %d dollars!" % dollars_count
...
#cash_in_wallet = raw_input("Or we can just let you tell me?:", dollars_count, cents_count)
#print ("Great! that's %s dollars and %s cents!") % (dollar_count, cents_count)